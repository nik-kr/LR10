...
namespace LR10 {
    ...
    public partial class DatabaseDataSet2 : global::System.Data.DataSet {
        ...
        public partial class ПользователиDataTable : global::System.Data.TypedTableBase<ПользователиRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ПользователиRow AddПользователиRow(string Логин, string Пароль, string Права, string Имя_пользователя) {
            ...
            private void InitClass() {
                ...
                this.columnИмя_пользователя.MaxLength = 255;
            }
            ...
            public string Имя_пользователя {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Имя пользователя\' в таблице \'Пользователи\' равно DBNull.", e);
                    }
                }
                set {
...
namespace LR10.DatabaseDataSet2TableAdapters {
    ...
    public partial class ПользователиTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Пользователи` WHERE ((`Код` = ?) AND ((? = 1 AND `Пароль` IS NULL) O" +
                "R (`Пароль` = ?)) AND ((? = 1 AND `Права` IS NULL) OR (`Права` = ?)) AND ((? = 1" +
                " AND `Имя пользователя` IS NULL) OR (`Имя пользователя` = ?)))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_Права", global::System.Data.OleDb.OleDbType.VarWChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Права", global::System.Data.DataRowVersion.Original, false, null));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("IsNull_Имя_пользователя", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Имя пользователя", global::System.Data.DataRowVersion.Original, true, null));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_Имя_пользователя", global::System.Data.OleDb.OleDbType.VarWChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Имя пользователя", global::System.Data.DataRowVersion.Original, false, null));
            this._adapter.InsertCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Пользователи` (`Логин`, `Пароль`, `Права`, `Имя пользователя`) VALUE" +
                "S (?, ?, ?, ?)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Имя_пользователя", global::System.Data.OleDb.OleDbType.VarWChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Имя пользователя", global::System.Data.DataRowVersion.Current, false, null));
            this._adapter.UpdateCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Пользователи` SET `Логин` = ?, `Пароль` = ?, `Права` = ?, `Имя пользователя` = ? WHERE ((`Код` = ?) AND ((? = 1 AND `Пароль` IS NULL) OR (`Пароль` = ?)) AND ((? = 1 AND `Права` IS NULL) OR (`Права` = ?)) AND ((? = 1 AND `Имя пользователя` IS NULL) OR (`Имя пользователя` = ?)))";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Права", global::System.Data.OleDb.OleDbType.VarWChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Права", global::System.Data.DataRowVersion.Current, false, null));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Имя_пользователя", global::System.Data.OleDb.OleDbType.VarWChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Имя пользователя", global::System.Data.DataRowVersion.Current, false, null));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_Права", global::System.Data.OleDb.OleDbType.VarWChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Права", global::System.Data.DataRowVersion.Original, false, null));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("IsNull_Имя_пользователя", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Имя пользователя", global::System.Data.DataRowVersion.Original, true, null));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_Имя_пользователя", global::System.Data.OleDb.OleDbType.VarWChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Имя пользователя", global::System.Data.DataRowVersion.Original, false, null));
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Код, Логин, Пароль, Права, [Имя пользователя] FROM Пользователи";
        ...
        public virtual int Fill(DatabaseDataSet2.ПользователиDataTable dataTable) {
        ...
        public virtual DatabaseDataSet2.ПользователиDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseDataSet2.ПользователиDataTable dataTable = new DatabaseDataSet2.ПользователиDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseDataSet2.ПользователиDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Код, string Original_Пароль, string Original_Права, string Original_Имя_пользователя) {
            ...
            if ((Original_Права == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((string)(Original_Права));
            }
            if ((Original_Имя_пользователя == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((string)(Original_Имя_пользователя));
            }
        ...
        public virtual int Insert(string Логин, string Пароль, string Права, string Имя_пользователя) {
            if ((Логин == null)) {
            ...
            if ((Имя_пользователя == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[3].Value = ((string)(Имя_пользователя));
            }
        ...
        public virtual int Update(string Логин, string Пароль, string Права, string Имя_пользователя, int Original_Код, string Original_Пароль, string Original_Права, string Original_Имя_пользователя) {
            if ((Логин == null)) {
            ...
            if ((Права == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Права));
            }
            if ((Имя_пользователя == null)) {
                this.Adapter.UpdateCommand.Parameters[3].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(Имя_пользователя));
            }
            ...
            if ((Original_Права == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Original_Права));
            }
            if ((Original_Имя_пользователя == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_Имя_пользователя));
            }
